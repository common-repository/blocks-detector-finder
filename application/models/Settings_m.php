...
class Settings_m extends Winter_MVC_Model {
	...
	public function __construct(){
        ...
        $pages = array('' => __('Not Selected', 'blocks-detector-finder'));
        ...
        $this->fields_list = array( 
            array('field' => 'bpdf_editor_hover', 'field_label' => __('Widget Name Inside Editor', 'blocks-detector-finder'), 'hint' => __('Show Widget Name inside Elementor Editor on WIdget Mouseover', 'blocks-detector-finder'), 'field_type' => 'CHECKBOX', 'rules' => ''),
        );
